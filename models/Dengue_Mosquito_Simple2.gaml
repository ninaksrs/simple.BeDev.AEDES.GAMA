...
experiment main type: gui {
    output {
        display main_display type: 2d background: rgb(10, 40, 55){
        	// เพิ่มแสงสว่าง (เหมือนดวงอาทิตย์)
            light #ambient intensity: 100;
            light #default intensity: 150;
...
// ปรับระดับความสูงของสิ่งต่างๆ (Z-axis)
            species Backyard; // พื้นอยู่ที่ Z=0
            species home position: {0,0,0.1};
            species frog;
            species pool;
            species flower;
            species person;
species male_mosquito position: {0,0,1.5}; // ให้บินสูงจากพื้น
species player_female_mosquito position: {0,0,2.0};
